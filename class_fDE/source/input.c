...
int input_read_parameters_species(struct file_content * pfc,
  ...
  if (pba->Omega0_fld != 0.) {
    ...
    if (flag1 == _TRUE_) {
      ...
      else if ((strstr(string1,"faDE") != NULL) || (strstr(string1,"fade") != NULL)) {
	      pba->fluid_equation_of_state = faDE;
      }
      else if ((strstr(string1,"fpDE") != NULL) || (strstr(string1,"fpde") != NULL)) {
	      pba->fluid_equation_of_state = fpDE;
      }
      else if ((strstr(string1,"faDE_2") != NULL) || (strstr(string1,"fade_2") != NULL)) {
	      pba->fluid_equation_of_state = faDE2;
      }
      else if ((strstr(string1,"fpDE_2") != NULL) || (strstr(string1,"fpde_2") != NULL)) {
    ...
    if (pba->fluid_equation_of_state == fpDE) {
     ...
     if (pba->fluid_equation_of_state == fpDE2) {
	     /* Read */
	     class_read_double("fp_fld",pba->fp_fld);
	     class_read_double("dfp_fld",pba->dfp_fld);
	     class_read_double("ap_fld",pba->ap_fld);
	     class_read_double("cs2_fld",pba->cs2_fld);
     }
